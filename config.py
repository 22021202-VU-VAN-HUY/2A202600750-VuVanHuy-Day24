...
# MimoAPI exposes an OpenAI-compatible /v1 API, so the rest of the lab can use
# the normal OpenAI SDK while switching credentials and base URL here.
...
LLM_API_KEY = MIMO_API_KEY or OPENAI_API_KEY
LLM_BASE_URL = MIMO_BASE_URL if MIMO_API_KEY else OPENAI_BASE_URL
LLM_MODEL = MIMO_MODEL if MIMO_API_KEY else OPENAI_MODEL
